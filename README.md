...
* utdemir/ghc-musl:v21-ghc901
* utdemir/ghc-musl:v21-ghc8107
* utdemir/ghc-musl:v21-ghc884
...
```
$ cd myproject/
$ docker run -itv $PWD:/mnt utdemir/ghc-musl:v21-ghc901
sh$ cd /mnt
sh$ cabal new-update
...
stack build \
  ...
  --docker --docker-image "utdemir/ghc-musl:v21-ghc901" \
  --no-nix
```
