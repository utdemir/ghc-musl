...
* `utdemir/ghc-musl:v11-libgmp-ghc8101`
* `utdemir/ghc-musl:v11-integer-simple-ghc8101`
* `utdemir/ghc-musl:v11-libgmp-ghc883`
* `utdemir/ghc-musl:v11-integer-simple-ghc883`
* `utdemir/ghc-musl:v11-libgmp-ghc865`
* `utdemir/ghc-musl:v11-integer-simple-ghc865`
...
```
$ cd myproject/
$ docker run -itv $(pwd):/mnt utdemir/ghc-musl:v11-libgmp-ghc8101
sh$ cd /mnt
sh$ cabal new-update
...
docker:
  enable: true
  image: utdemir/ghc-musl:v11-libgmp-ghc8101
```
